...
import android.content.res.IThemeHelper;

interface IThemeHelperService {

    /**
     * Register the ThemeHelper service delegate
     */
    void registerThemeHelper(IThemeHelper callbacks);
